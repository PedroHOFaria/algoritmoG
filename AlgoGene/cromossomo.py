...
# Exibir o resultado
print("Melhores indivíduos por geração:")
for i, individuo in enumerate(melhor_individuo_por_geracao):
    print(f"Geração {i+1}: Valor = {individuo[0]}, Cromossomo = {individuo[1]}")

# Exibir a melhor solução final
print(f"\nMelhor solução final: Valor = {melhor_fitness_geral}, Cromossomo = {melhor_individuo_geral}")